<?php
    ...
    $response_object = $api->get_api_list_new_films($page);
?>

<div class="title my-5">
    <h1 class="text-center"><strong>PHIM MỚI CẬP NHẬT</strong></h1>
</div>
...
echo '<script>
        function goToPage(pageNumber) {
            window.location.href = "?controller=movie&action=newmovies&page=" + pageNumber;
        }
        </script>';

    $totalPages = $response_object['pagination']['totalPages'] ?? 1;

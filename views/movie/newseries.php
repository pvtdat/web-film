<?php
    ...
    $response_object = $api->get_api_list_new_series($page)['data'];
    $url_src = $response_object['APP_DOMAIN_CDN_IMAGE'];
?>

<div class="title my-4">
    <h1 class="text-center"><strong>PHIM BỘ MỚI</strong></h1>
</div>
...
echo '<script>
        function goToPage(pageNumber) {
            window.location.href = "?controller=movie&action=newseries&page=" + pageNumber;
        }
        </script>';
